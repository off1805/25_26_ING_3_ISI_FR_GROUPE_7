...
import com.projetTransversalIsi.structure_academique.infrastructure.persistence.mapper.FiliereMapper;
...
public class JpaFiliereRepository implements FiliereRepository {
    ...
    public List<Filiere> search(SearchFiliereRequestDTO command){
        // JpaFiliereSpec will be in the same package or subpackage
        Specification<JpaFiliereEntity> spec = JpaFiliereSpec.inCycle(command.cycleId());
